...
class KITTI(imdb):
    ...
    def _load_image_set_index(self):
        ...
        print("data_path is"+ self._data_path)
        print("self.image_set is " + self._image_set)
...
#################111111111111111111111111111111
	...
	print('okay write voc is finished\n')

# data/KITTI/
# output_dir = output/res101/KITTI_test/default/res101_faster_rcnn_iter_100000
...
#        comp_id = self._write_KITTI_results_file(all_boxes)
